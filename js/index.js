...
const QUIZ = [
    ...
    {
        question: 'DNA is made up of basepairs - A, T, G, C. How many letters do we have in a human genome?',
        answers: {
            a: '2 million',
            b: '82 million',
            c: '3 200 million',
...
function rightAnswer() {
    ...
    <img src="images/happy.jpg" alt="happy scientist" class="images" width="200px">
      <p class="js-options">You know your DNA!</p>
...
function wrongAnswer() {
    ...
    <img src="images/sad.jpg" alt="sad scientist" class="images" width="200px">
      <p class="js-options">The right answer is: </p>
      <p class="js-options">${QUIZ[questionNumber].correctAnswer} </p>
      <button type="button" class="nextButton button"> Next </button>`
    );
